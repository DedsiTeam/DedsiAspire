...
[DependsOn(
    typeof(DedsiServiceCHttpApiModule),

    typeof(AbpEntityFrameworkCoreSqlServerModule),
    typeof(AbpAutofacModule)
)]
public class DedsiServiceCHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = DedsiServiceCDomainConsts.ApplicationName;
