...
using DedsiServiceC.Users.CommandHandlers;
using DedsiServiceC.Users.Dtos;
using DedsiServiceC.Users.Queries;

namespace DedsiServiceC.Users;

public class UserController(IUserQuery userQuery,IDedsiMediator dedsiMediator) : DedsiServiceCController
{
    /// <summary>
    /// 创建用户
    /// </summary>
