...
[DependsOn(
    typeof(DedsiServiceBHttpApiModule),

    typeof(AbpEntityFrameworkCoreSqlServerModule),
    typeof(AbpAutofacModule)
)]
public class DedsiServiceBHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = DedsiServiceBDomainConsts.ApplicationName;
