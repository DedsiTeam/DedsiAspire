...
[DependsOn(
    typeof(DedsiServiceAHttpApiModule),

    typeof(AbpEntityFrameworkCoreSqlServerModule),
    typeof(AbpAutofacModule)
)]
public class DedsiServiceAHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = DedsiServiceADomainConsts.ApplicationName;
