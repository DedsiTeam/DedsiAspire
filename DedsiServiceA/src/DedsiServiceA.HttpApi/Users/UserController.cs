...
using DedsiServiceA.Users.CommandHandlers;
using DedsiServiceA.Users.Dtos;
using DedsiServiceA.Users.Queries;

namespace DedsiServiceA.Users;

public class UserController(IUserQuery userQuery,IDedsiMediator dedsiMediator) : DedsiServiceAController
{
    /// <summary>
    /// 创建用户
    /// </summary>
